...
?>
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/">
                    ...
                    <div class="sidebar-brand-text mx-3">Digital Cash</div>
                </a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Charges</h1>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">All Charges Details</h6>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive rounded">
                                            <table class="table table-striped table-hover" id="rateTable" width="100%" cellspacing="0">
                                                <thead class="bg-warning shadow">
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Currency</th>
                                                        <th>Rate</th>
        ...
        <script src="js/ratedata.js"></script>
