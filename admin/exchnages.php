    ...
    <body>
        <div class="wrapper">
            ...
            <div class="container" id="data" style="display: none;">
                <h5 class="text-secondary my-3"><i class="fas fa-user"></i>&nbsp;Exchnages Overview</h5>
                <div class="row my-5">
        ...
        <script>
            function fetchdata() {
                $.ajax({
                    url: 'server.php?data=exchnages',
                    type: 'post',
                    success: function(response) {
                        $('#exchnage-data').html(response);
                    }
