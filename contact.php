...
<body>
            ...
            <div class="row my-5 pt-2">
                <div class="col-lg-8 col-md-8 col-12">
                    <div class="card w-75 mx-auto shadow">
                        <div class="card-body">
                            <form action="#" method="post" id="contact-data">
                                <h5 class="text-center text-heading">Contact Us</h5>
                                <hr>
                                <div class="form-group">
                                    <div class="form_div">
                                        <input type="text" name="name" id="name" class="form_input" placeholder=" ">
                                        <label for="name" id="name-label" class="form_label">Full Name</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form_div">
                                ...
                                <div class="form-group">
                                    <div class="form_div">
                                        <input type="text" name="comment" id="comment" class="form_input" placeholder=" ">
                                        <label for="comment" id="comment-label" class="form_label">Reson for contact</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="button" onclick="contact()" class="btn btn-primary btn-block">Submit</button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <img src="assets/contact.svg" alt="" class="img-fluid animated-element">
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        function contact() {
            $.ajax({
                url: 'action.php?contact=1',
                type: 'post',
                data: $('#contact-data').serialize(),
                success: function(response) {
                    ...
                    if (response == 'empty_comment') {
                        alert('Reason required !');
                    }
                    if (response == 'success') {
                        alert('Thank your for contact ! we will connect with you shortly');
                    }
                }
            });
        }
