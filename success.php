...
<head>
    ...
    <title>Exchnages - Payment Success</title>
</head>
            ...
            <div class="row my-5 pt-2">
                <div class="col-lg-8 col-md-8 col-12">
                    <div class="card w-75 mx-auto shadow">
                        <div class="card-body">
                            <h5 class="text-center text-heading">Payment Successfull</h5>
                            <?php
                            if (isset($_GET['type'])) {
                                $type = $_GET['type'];
                                $transectionid = $_GET['transectionid'];
                                $transectionid = $_GET['transectionid'];
                                $senetamount = $_GET['senetamount'];
                                $charge = $_GET['charge'];
                                $total = $_GET['total'];
                                $total = $_GET['total'];
                                $status = $_GET['status'];
                                ...
                                echo "
                                            ...
                                            <div class='d-flex justify-content-between'>
                                                <p class='badge badge-primary'>Transection ID : </p><span class='text-right'>$transectionid</span>
                                            </div>
                                            <div class='d-flex justify-content-between'>
                                                <p class='badge badge-success'>Sent Amount : </p><span class='text-right'>₹ $senetamount</span>
                                            </div>
                                            <div class='d-flex justify-content-between'>
                                                <p class='badge badge-success'>Charge Paid : </p><span class='text-right'>₹ $charge</span>
                                            </div>
                                            <div class='d-flex justify-content-between'>
                                                <p class='badge badge-success'>Total Paid : </p><span class='text-right'>₹ $total</span>
                                            </div>
                                            <div class='d-flex justify-content-between'>
                                                <p class='badge badge-success'>Transection Type : </p><span class='text-right'>$type</span>
                                            </div>
                                            <div class='d-flex justify-content-between'>
                                                <p class='badge badge-success'>Status : </p><span class='text-right'>$status</span>
                                            </div>
                                            <hr>
                                            <a href='/' class='btn btn-primary btn-block'>Make Another</a>
                                            <a href='track' class='btn btn-warning btn-block'>Track</a>
                                            <br>
                                        ";
                            }
                            ?>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <img src="assets/success.svg" alt="" class="img-fluid animated-element">
                </div>
            </div>
        </div>
    </section>
