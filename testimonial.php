            ...
            <div class="row my-5 pt-2">
                <div class="col-lg-8 col-md-8 col-12">
                    <div class="card w-75 mx-auto shadow">
                        <div class="card-body">
                            <h5 class="text-center text-heading">Testimonials</h5>
                            <hr>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique dolorem enim officia amet, voluptates delectus velit, deleniti in molestiae porro praesentium sed dolores id quis aliquam perspiciatis earum illo? Iusto!</p>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique dolorem enim officia amet, voluptates delectus velit, deleniti in molestiae porro praesentium sed dolores id quis aliquam perspiciatis earum illo? Iusto!</p>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique dolorem enim officia amet, voluptates delectus velit, deleniti in molestiae porro praesentium sed dolores id quis aliquam perspiciatis earum illo? Iusto!</p>
                            <hr>
