        ...
        <div class="container">
            <div class="row my-5 pt-2">
                <div class="col-lg-8 col-md-8 col-12">
                    <div id="details" class="card w-75 mx-auto shadow">
                        <div class="card-body">
                            <h5 class="text-center text-heading">Track Payments</h5>
                            <hr>
                            <form action="#" method="post" id="track-form">
                                <div class="form-group">
                                    <div class="form_div">
                                        <input type="text" name="transectionid" id="transectionid" class="form_input" placeholder=" ">
                                        <label for="transectionid" id="transectionid-label" class="form_label">Transection ID</label>
                                    </div>
                                </div>
                                <br>
                                <div class="form-group">
                                    <button type="button" onclick="track()" class="btn btn-primary btn-block">Track</button>
                                </div>
                            </form>
                        </div>
                    </div>
